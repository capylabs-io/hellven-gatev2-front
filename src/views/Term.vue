<template>
  <div class="main-content" :style="{ backgroundColor: '#12163D' }">
    <div class="content mx-auto white--text py-12">
      <h2><strong>Terms and Conditions</strong></h2>

      <p>Welcome to Fighter-Force!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Fighter-Force's Website, located at http://localhost:8080/term.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Fighter-Force if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Fighter-Force, you agreed to
        use cookies in agreement with the Fighter-Force's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Fighter-Force and/or its licensors own the
        intellectual property rights for all material on Fighter-Force. All
        intellectual property rights are reserved. You may access this from
        Fighter-Force for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Fighter-Force</li>
        <li>Sell, rent or sub-license material from Fighter-Force</li>
        <li>Reproduce, duplicate or copy material from Fighter-Force</li>
        <li>Redistribute content from Fighter-Force</li>
      </ul>
      ...
      <p>
        ...
        Fighter-Force does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Fighter-Force,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Fighter-Force shall not be
      ...
      <p>
        Fighter-Force reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Fighter-Force a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Fighter-Force; and (d) the link
      ...
      <p>
        ...
        e-mail to Fighter-Force. Please include your name, your organization
      ...
      <p>
        No use of Fighter-Force's logo or other artwork will be allowed for
