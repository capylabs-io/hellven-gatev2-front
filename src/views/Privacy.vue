<template>
  <div class="main-content" :style="{ backgroundColor: '#12163D' }">
    <div class="content mx-auto white--text py-12">
      <h1>Privacy Policy for Fighter-Force</h1>

      <p>
        At Fighter-Force, accessible from http://localhost:8080/privacy, one of
        ...
        Fighter-Force and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Fighter-Force. This policy is not applicable to
      ...
      <p>
        Fighter-Force follows a standard procedure of using log files. These
      ...
      <P
        ...
        advertising partners of Fighter-Force.</P
      >

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Fighter-Force, which are sent
      ...
      <p>
        Note that Fighter-Force has no access to or control over these cookies
      ...
      <p>
        Fighter-Force's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Fighter-Force does not knowingly collect any Personal Identifiable
