      ...
      <v-list>
        <v-list-item>
          <v-list-item-content>
            ...
            <v-list-item-content>Khoi Vo</v-list-item-content>
          </v-list-item-content>
        </v-list-item>
        <v-list-item>
          <v-list-item-content>
            <v-list-item-subtitle>Country / Region</v-list-item-subtitle>
            <v-list-item-content>Vietnam</v-list-item-content>
          </v-list-item-content>
        </v-list-item>
        <v-list-item>
          <v-list-item-content>
            <v-list-item-subtitle>D.O.B</v-list-item-subtitle>
            <v-list-item-content>19/04/1996</v-list-item-content>
          </v-list-item-content>
        </v-list-item>
      </v-list>
    </v-card>
      ...
      <v-list>
        <v-list-item>
          <v-list-item-content>
            ...
            <v-list-item-content
              >khoivo.ba.dev.design.test@gmail.com</v-list-item-content
            >
          </v-list-item-content>
        </v-list-item>
      </v-list>
